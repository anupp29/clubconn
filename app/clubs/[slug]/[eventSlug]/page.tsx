...
const eventData = {
  ...
  "conference-2025": {
    ...
    title: "ML Nashik Conference 2025",
    description:
      "Annual machine learning conference featuring cutting-edge research, industry applications, and hands-on workshops on AI/ML technologies.",
    date: "2025-09-27",
    time: "9:00 AM - 6:00 PM",
    location: "Nashik Convention Center",
    banner: "/placeholder.svg?height=400&width=1200",
    objectives: [
      "Showcase latest advancements in machine learning and AI",
      "Provide platform for researchers to present their work",
      "Foster collaboration between academia and industry",
      "Inspire next generation of ML practitioners",
    ],
    learnings: [
      "State-of-the-art ML algorithms and techniques",
      "Real-world AI applications across industries",
      "Best practices in model deployment and MLOps",
      "Ethical considerations in AI development",
    ],
    speakers: [
      {
        name: "Dr. Rajesh Sharma",
        designation: "AI Research Lead, Google Brain",
        bio: "Dr. Sharma leads research in deep learning and neural networks at Google Brain. He has published over 50 papers in top-tier conferences.",
        photo: "/placeholder.svg?height=200&width=200",
      ...
      {
        name: "Ms. Priya Desai",
        designation: "ML Engineer, Microsoft",
        bio: "Priya specializes in building production ML systems and has extensive experience in MLOps and model deployment.",
        photo: "/placeholder.svg?height=200&width=200",
    ...
    agenda: [
      { time: "9:00 AM", activity: "Registration & Welcome Coffee", duration: "60 min" },
      { time: "10:00 AM", activity: "Keynote: Future of AI", duration: "90 min" },
      { time: "11:30 AM", activity: "Research Paper Presentations", duration: "90 min" },
      { time: "1:00 PM", activity: "Lunch & Networking", duration: "60 min" },
      { time: "2:00 PM", activity: "Hands-on ML Workshops", duration: "180 min" },
      { time: "5:00 PM", activity: "Panel Discussion & Closing", duration: "60 min" },
    ],
    capacity: 300,
    registered: 285,
    attended: 268,
    ...
    eventReport: {
      highlights: [
        "Successfully organized India's largest ML conference in Nashik",
        "268 participants from 20+ colleges and companies",
        "15 research papers presented by leading researchers",
        "8 hands-on workshops on cutting-edge ML technologies",
      ...
      testimonials: [
        {
          name: "Arjun Patil",
          year: "PhD Student, IIT Bombay",
          feedback:
            "Outstanding conference! The research presentations were world-class and the workshops provided hands-on experience with latest ML frameworks. Highly recommend!",
          rating: 5,
        },
        {
          name: "Sneha Kulkarni",
          year: "ML Engineer, TCS",
          feedback:
            "Best ML conference I've attended in India. Great mix of theory and practice. The networking opportunities were invaluable for my career.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/ml-conference-keynote.jpg", caption: "Keynote session on Future of AI" },
        { url: "/ml-workshop-session.jpg", caption: "Hands-on ML workshop in progress" },
        { url: "/ml-networking-event.jpg", caption: "Networking session with industry leaders" },
      ],
      team: [
        {
          name: "Rahul Deshmukh",
          ...
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Overall conference planning and execution",
        },
        {
          name: "Priya Joshi",
          role: "Program Committee",
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Paper selection and speaker coordination",
        },
        {
          name: "Amit Sharma",
          role: "Workshop Coordinator",
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Organizing hands-on workshops",
        },
      ],
      impactMetrics: [
        { label: "Total Participants", value: "268", icon: Users },
        { label: "Satisfaction Rate", value: "94%", icon: Star },
        { label: "Research Papers", value: "15", icon: Trophy },
        { label: "Industry Partners", value: "12", icon: Handshake },
      ],
    },
  },
  ...
  "workshop-advanced-topics": {
    ...
    title: "Workshop: Advanced React Topics",
    description: "Deep dive into advanced React patterns, performance optimization, and modern React ecosystem.",
    date: "2025-08-23",
    time: "10:00 AM - 5:00 PM",
    location: "Innovation Hub, Nashik",
    banner: "/placeholder.svg?height=400&width=1200",
    objectives: [
    ...
    speakers: [
      {
        name: "Mr. Karan Mehta",
        designation: "Senior Frontend Engineer, Vercel",
        bio: "Karan is a core contributor to Next.js and has extensive experience building large-scale React applications.",
        photo: "/placeholder.svg?height=200&width=200",
    ...
    agenda: [
      { time: "10:00 AM", activity: "Advanced Hooks Deep Dive", duration: "120 min" },
      { time: "12:00 PM", activity: "Lunch Break", duration: "60 min" },
      { time: "1:00 PM", activity: "React Server Components", duration: "120 min" },
      { time: "3:00 PM", activity: "Performance Optimization", duration: "120 min" },
    ],
    capacity: 80,
    registered: 76,
    attended: 72,
    status: "completed",
    clubSlug: "react-nashik",
    clubName: "React Nashik",
    eventReport: {
      highlights: [
        "Comprehensive workshop on advanced React concepts",
        "72 developers enhanced their React skills",
        "Hands-on coding exercises with real-world examples",
        "Live code reviews and best practices shared",
      ],
      statistics: {
        registrations: 76,
        attendance: 72,
      ...
      testimonials: [
        {
          ...
          feedback:
            "Excellent workshop! Karan's explanations were crystal clear and the hands-on exercises really helped solidify the concepts.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/placeholder.svg?height=400&width=600", caption: "Workshop session in progress" },
        { url: "/placeholder.svg?height=400&width=600", caption: "Participants coding together" },
      ],
      team: [
        {
          name: "Neha Patil",
          role: "Workshop Coordinator",
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Workshop planning and execution",
        },
      ],
      impactMetrics: [
        { label: "Participants", value: "72", icon: Users },
        { label: "Satisfaction Rate", value: "95%", icon: Star },
        { label: "Topics Covered", value: "4", icon: Trophy },
        { label: "Code Examples", value: "20+", icon: Handshake },
      ],
    },
  },
  ...
  "hackathon-weekend": {
    ...
    title: "Flutter Nashik Hackathon Weekend",
    description: "48-hour hackathon to build innovative mobile applications using Flutter and Dart.",
    date: "2025-05-24",
    time: "9:00 AM (Day 1) - 5:00 PM (Day 2)",
    location: "Startup Incubator, Nashik",
    banner: "/placeholder.svg?height=400&width=1200",
    objectives: [
      "Build innovative mobile apps in 48 hours",
      "Learn Flutter best practices from mentors",
      "Network with Flutter developers",
      "Win prizes and recognition",
    ],
    learnings: [
      "Rapid app development with Flutter",
    ...
    speakers: [
      {
        name: "Mr. Rohan Desai",
        designation: "Flutter GDE, Google",
        bio: "Rohan is a Google Developer Expert for Flutter and has built multiple production Flutter apps.",
        photo: "/placeholder.svg?height=200&width=200",
    ...
    agenda: [
      { time: "Day 1 - 9:00 AM", activity: "Hackathon Kickoff & Team Formation", duration: "120 min" },
      { time: "Day 1 - 11:00 AM", activity: "Hacking Begins", duration: "480 min" },
      { time: "Day 2 - 9:00 AM", activity: "Final Sprint", duration: "360 min" },
      { time: "Day 2 - 3:00 PM", activity: "Project Presentations", duration: "120 min" },
    ],
    capacity: 100,
    registered: 95,
    attended: 90,
    status: "completed",
    clubSlug: "flutter-nashik",
    clubName: "Flutter Nashik",
    eventReport: {
      highlights: [
        "22 teams built innovative Flutter apps in 48 hours",
        "90 developers participated in the hackathon",
        "Mentorship from Flutter experts throughout",
        "Top 3 teams won prizes worth ₹1,00,000",
      ],
      statistics: {
        registrations: 95,
        attendance: 90,
      ...
      testimonials: [
        {
          name: "Aditya Kumar",
          year: "Mobile Developer",
          feedback:
            "Intense but amazing experience! Built my first production-ready Flutter app in 48 hours with great mentorship.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/placeholder.svg?height=400&width=600", caption: "Teams hacking away" },
        { url: "/placeholder.svg?height=400&width=600", caption: "Final presentations" },
      ],
      team: [
        {
          ...
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Overall hackathon coordination",
        },
      ],
      impactMetrics: [
        { label: "Teams", value: "22", icon: Users },
        { label: "Satisfaction Rate", value: "95%", icon: Star },
        { label: "Apps Built", value: "22", icon: Trophy },
        { label: "Prize Money", value: "₹1L", icon: DollarSign },
      ],
    },
  },
  ...
  "summer-meetup-2025": {
    ...
    title: "FOSS United Nashik Summer Meetup 2025",
    description: "Community meetup to discuss open source contributions, FOSS projects, and Linux ecosystem.",
    date: "2025-07-16",
    time: "2:00 PM - 6:00 PM",
    location: "Nashik Tech Park",
    banner: "/placeholder.svg?height=400&width=1200",
    objectives: [
      "Promote FOSS culture in Nashik",
      "Share knowledge about open source projects",
      "Encourage contributions to FOSS",
      "Build strong FOSS community",
    ],
    learnings: [
    ...
    speakers: [
      {
        name: "Mr. Anand Verma",
        designation: "FOSS Advocate & Linux Contributor",
        bio: "Anand has been contributing to Linux kernel and various FOSS projects for over 10 years.",
        photo: "/placeholder.svg?height=200&width=200",
        linkedin: "https://linkedin.com/in/anandverma",
        topics: ["Linux", "Open Source", "FOSS"],
      },
    ],
    agenda: [
      { time: "2:00 PM", activity: "Welcome & FOSS Introduction", duration: "45 min" },
      { time: "2:45 PM", activity: "Talk: Contributing to Open Source", duration: "60 min" },
      { time: "3:45 PM", activity: "Tea Break & Networking", duration: "30 min" },
      { time: "4:15 PM", activity: "Lightning Talks & Project Showcases", duration: "90 min" },
    ],
    capacity: 120,
    registered: 110,
    attended: 105,
    status: "completed",
    clubSlug: "foss-united-nashik",
    clubName: "FOSS United Nashik",
    eventReport: {
      highlights: [
        "105 FOSS enthusiasts gathered for knowledge sharing",
        "10 lightning talks on various FOSS projects",
        "Live demo of contributing to open source",
        "Strong community connections formed",
      ],
      statistics: {
        registrations: 110,
        attendance: 105,
      ...
      testimonials: [
        {
          name: "Rahul Mehta",
          year: "Open Source Contributor",
          feedback:
            "Great meetup! Met amazing people passionate about FOSS. Anand's talk inspired me to start contributing.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/placeholder.svg?height=400&width=600", caption: "Community gathering" },
        { url: "/placeholder.svg?height=400&width=600", caption: "Lightning talks session" },
      ],
      team: [
        {
          name: "Priya Singh",
          ...
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Meetup coordination and community building",
        },
      ],
      impactMetrics: [
        { label: "Attendees", value: "105", icon: Users },
        { label: "Satisfaction Rate", value: "95%", icon: Star },
        { label: "Lightning Talks", value: "10", icon: Trophy },
        { label: "Projects Showcased", value: "8", icon: Handshake },
      ],
    },
  },
  ...
  "april-meetup": {
    slug: "april-meetup",
    title: "CyberX Nashik April Meetup",
    description: "Monthly cybersecurity meetup covering ethical hacking, penetration testing, and security research.",
    date: "2025-04-26",
    time: "3:00 PM - 6:00 PM",
    location: "Co-working Space, Nashik",
    banner: "/placeholder.svg?height=400&width=1200",
    objectives: [
      "Share latest cybersecurity trends and threats",
    ...
    speakers: [
      {
        name: "Mr. Karan Patel",
        designation: "Security Researcher, Bugcrowd",
        bio: "Karan is a renowned bug bounty hunter and has found critical vulnerabilities in major tech companies.",
        photo: "/placeholder.svg?height=200&width=200",
        linkedin: "https://linkedin.com/in/karanpatel",
        topics: ["Ethical Hacking", "Bug Bounty", "Web Security"],
      },
    ],
    agenda: [
      { time: "3:00 PM", activity: "Welcome & Security News Roundup", duration: "30 min" },
      { time: "3:30 PM", activity: "Talk: Web Application Security", duration: "90 min" },
      { time: "5:00 PM", activity: "Live Hacking Demo", duration: "60 min" },
    ],
    capacity: 80,
    registered: 75,
    attended: 70,
    status: "completed",
    clubSlug: "cyberx-nashik",
    clubName: "CyberX Nashik",
    eventReport: {
      highlights: [
        "70 security enthusiasts learned ethical hacking",
        "Live demonstration of web app vulnerabilities",
        "Hands-on practice with security tools",
        "Bug bounty tips and tricks shared",
      ],
      statistics: {
        registrations: 75,
        attendance: 70,
      ...
      testimonials: [
        {
          name: "Amit Sharma",
          year: "Security Analyst",
          feedback:
            "Excellent meetup! Karan's live hacking demo was eye-opening. Learned practical techniques I can apply immediately.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/placeholder.svg?height=400&width=600", caption: "Live hacking demonstration" },
        { url: "/placeholder.svg?height=400&width=600", caption: "Security tools workshop" },
      ],
      team: [
        {
          name: "Rohan Deshmukh",
          ...
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Monthly meetup coordination",
        },
      ],
      impactMetrics: [
        { label: "Attendees", value: "70", icon: Users },
        { label: "Satisfaction Rate", value: "93%", icon: Star },
        { label: "Vulnerabilities Demoed", value: "5", icon: Trophy },
        { label: "Tools Covered", value: "8", icon: Handshake },
      ],
    },
  },
  ...
  "march-tech-talk": {
    ...
    title: "Pune Tech Community March Tech Talk",
    description: "Monthly tech talk series featuring industry experts discussing latest technology trends.",
    date: "2025-03-22",
    ...
    objectives: [
      ...
      "Connect tech professionals in Pune",
    ...
    speakers: [
      {
        ...
        bio: "Dr. Kumar has 20+ years of experience in technology leadership and has built multiple successful products.",
        photo: "/placeholder.svg?height=200&width=200",
        linkedin: "https://linkedin.com/in/sureshkumar",
        topics: ["Technology Leadership", "Product Development", "Startups"],
      },
    ],
    agenda: [
      { time: "4:00 PM", activity: "Welcome & Community Updates", duration: "30 min" },
      { time: "4:30 PM", activity: "Keynote: Future of Technology", duration: "90 min" },
      { time: "6:00 PM", activity: "Networking & Refreshments", duration: "60 min" },
    ],
    capacity: 200,
    registered: 180,
    attended: 170,
    status: "completed",
    clubSlug: "pune-tech",
    clubName: "Pune Tech Community",
    eventReport: {
      highlights: [
        "170 tech professionals attended the talk",
        "Insightful keynote on technology trends",
      ...
      testimonials: [
        {
          ...
          feedback:
            "Great tech talk! Dr. Kumar's insights on technology leadership were very valuable. Met many interesting people.",
          rating: 5,
        },
      ],
      photos: [
        { url: "/placeholder.svg?height=400&width=600", caption: "Keynote presentation" },
        { url: "/placeholder.svg?height=400&width=600", caption: "Networking session" },
      ],
      team: [
        {
          ...
          role: "Community Lead",
          photo: "/placeholder.svg?height=100&width=100",
          responsibilities: "Community management and event coordination",
        },
      ],
      impactMetrics: [
        { label: "Attendees", value: "170", icon: Users },
        { label: "Satisfaction Rate", value: "94%", icon: Star },
        { label: "Connections Made", value: "100+", icon: Trophy },
        { label: "Companies Represented", value: "30", icon: Handshake },
      ],
    },
  },
}
